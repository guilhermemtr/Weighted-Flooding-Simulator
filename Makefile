...
KOUT_BENCH_OBJECTS=$(KOUT_BENCH_SOURCES:$(FILE_PREFIX)=$(OBJ))
HYBRID_OBJECTS=$(HYBRID_SOURCES:$(FILE_PREFIX)=$(OBJ))


KOUT_BENCH_EXECUTABLE=bench-bin
KOUT_EXECUTABLE=kout-bin
HYBRID_EXECUTABLE=hybrid-bin
...
bench: $(KOUT_BENCH_SOURCES) $(KOUT_BENCH_EXECUTABLE)
	$(CC) $(CFLAGS) $(KOUT_BENCH_OBJECTS) -o $(KOUT_BENCH_EXECUTABLE) $(LDFLAGS)
...
$(KOUT_BENCH_EXECUTABLE):$(KOUT_BENCH_OBJECTS)
...
clean:
	$(RM) $(KOUT_OBJECTS) $(KOUT_BENCH_OBJECTS) $(HYBRID_OBJECTS) $(KOUT_EXECUTABLE) $(HYBRID_EXECUTABLE) $(KOUT_BENCH_EXECUTABLE)
